...
<main>
    @if (session()->get('vote') > 8)
        ...
        <h4>Будем очень признательны, если вы уделите ещё минуту своего <br />
            ...
            <a target="_blank" style="font-size: 16px;" href="http://kiev.prom.ua/opinions/list/2054335">Prom.ua</a>&nbsp; и&nbsp; <a target="_blank" style="font-size: 16px;" href="https://search.google.com/local/writereview?placeid=ChIJy5LAnKbF1EARJ_CkshyRihY">Карты Google</a>
        </h4>
        <p>Оставить отзывы можно здесь:</p>
        <div class="remote-vote-btns">
            <a href="http://kiev.prom.ua/opinions/list/2054335"><img src="/imgs/prom_btn.png" /></a><a href="https://search.google.com/local/writereview?placeid=ChIJy5LAnKbF1EARJ_CkshyRihY"><img src="/imgs/google_btn.png" /></a>
        </div>
    @endif
